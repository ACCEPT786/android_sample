...
public final class BitmapUtils {
    ...
    public static int getDegress(byte[] data) {
    ...
    public static int getDegress( Context context, Uri uri) {
        ExifInterface ei = null;
        try {
    ...
    public static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, Context context, byte[] data) {
        ExifInterface ei = null;
        try {
            InputStream is = new ByteArrayInputStream(data);
            if (is != null) {
    ...
    public static int rotateBitmapByExif(ExifInterface exif) {
        int degrees;
        int orientation =
                exif.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_NORMAL);
        switch (orientation) {
