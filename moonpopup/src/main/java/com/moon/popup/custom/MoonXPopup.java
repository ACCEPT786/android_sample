...
public class MoonXPopup {
    ...
    public static class Builder {
        ...
        public MoonXPopup.Builder popupType(PopupType popupType) {
         ...
         *
         */
        public MoonXPopup.Builder dismissOnBackPressed(Boolean isDismissOnBackPressed) {
         ...
         *
         */
        public MoonXPopup.Builder dismissOnTouchOutside(Boolean isDismissOnTouchOutside) {
         ...
         *
         */
        public MoonXPopup.Builder autoDismiss(Boolean autoDismiss) {
         ...
         *
         */
        public MoonXPopup.Builder hasShadowBg(Boolean hasShadowBg) {
         ...
         *
         */
        public MoonXPopup.Builder atView(View atView) {
         ...
         *
         */
        public MoonXPopup.Builder watchView(View watchView) {
         ...
         *
         */
        public MoonXPopup.Builder popupAnimation(PopupAnimation popupAnimation) {
         ...
         *
         */
        public MoonXPopup.Builder customAnimator(PopupAnimator customAnimator) {
         ...
         *
         */
        public MoonXPopup.Builder maxWidth(int maxWidth) {
         ...
         *
         */
        public MoonXPopup.Builder maxHeight(int maxHeight) {
         ...
         *
         */
        public MoonXPopup.Builder autoOpenSoftInput(Boolean autoOpenSoftInput) {
         ...
         *
         */
        public MoonXPopup.Builder moveUpToKeyboard(Boolean isMoveUpToKeyboard) {
         ...
         *
         */
        public MoonXPopup.Builder popupPosition(PopupPosition popupPosition) {
         ...
         *
         */
        public MoonXPopup.Builder hasStatusBarShadow(boolean hasStatusBarShadow) {
         ...
         *
         */
        public MoonXPopup.Builder offsetX(int offsetX) {
         ...
         *
         */
        public MoonXPopup.Builder offsetY(int offsetY) {
         ...
         *
         */
        public MoonXPopup.Builder enableDrag(boolean enableDrag) {
         ...
         *
         */
        public MoonXPopup.Builder isCenterHorizontal(boolean isCenterHorizontal) {
         ...
         *
         */
        public MoonXPopup.Builder isRequestFocus(boolean isRequestFocus) {
         ...
         *
         */
        public MoonXPopup.Builder setPopupCallback(XPopupCallback xPopupCallback) {
